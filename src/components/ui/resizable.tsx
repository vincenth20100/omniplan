...
>(({ className, withHandle, ...props }, _ref) => (
  <ResizableHandlePrimitive
    className={cn(
      ...
      "transition-colors data-[resize-handle-state=hover]:bg-muted-foreground/20 data-[resize-handle-state=drag]:bg-muted-foreground/20",
      className
    )}
    {...props}
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm border bg-card shadow-sm">
